...
err_inf_avg = median(err_inf(:,1:rmin),"omitnan");
err_int_avg = median(err_int(:,1:rmin),"omitnan");
...
%% ANALYZE TEST DATA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mus_new = (max(mus) - min(mus)) .* rand(5,1) + min(mus);
...
%% Plotting
err_inf_avg_new = mean(err_inf_new,"omitnan");
err_int_avg_new = mean(err_int_new,"omitnan");
