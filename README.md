...
[<a href="#Peherstorfer16DataBibTex" id="PeherstorferDataDriven" onclick="toggle_visibility('Peherstorfer16DataBibTex');">BibTeX</a>]<div style="display: none" id="Peherstorfer16DataBibTex"><pre>@article{Peherstorfer16DataDriven,
